...
#python modules/train.py --dataset ./dataset --model ./models/liveness.model --le ./models/le.pickle
...
ap.add_argument("-m", "--model", type=str, default="./models/liveness.model", help="путь к тренированной модели")
ap.add_argument("-l", "--le", type=str, default="./models/le.pickle", help="путь к енкодеру классов")
ap.add_argument("-p", "--plot", type=str, default="./resources/plot.png", help="путь сохранения графика потерь/точности")
